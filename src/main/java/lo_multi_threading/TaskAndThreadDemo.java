...
public class TaskAndThreadDemo {
    ...
    public static void main(String ... args) {
        ...
        System.out.println("test_pkg.Main : started");
        ...
        System.out.println("test_pkg.Main : tasks created");
        ...
        System.out.println("test_pkg.Main : threads created");

        System.out.println("test_pkg.Main : threads [before started]");
        ...
        System.out.println("test_pkg.Main : After all threads");
